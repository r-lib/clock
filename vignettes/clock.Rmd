...
- With strings like `"2020-01-01T01:02:03-05:00[America/New_York]"` where there is both a time zone offset and time zone name present in the string, use `date_time_parse_complete()`.
