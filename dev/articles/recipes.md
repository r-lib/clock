...
In the high level API, you can use
[`date_seq()`](https://clock.r-lib.org/dev/reference/date_seq.md) to
...
[`date_seq()`](https://clock.r-lib.org/dev/reference/date_seq.md) also
...
In the high level API, you can use
[`date_group()`](https://clock.r-lib.org/dev/reference/date_group.md) to
