...
- [year-month-day](https://clock.r-lib.org/dev/reference/year-month-day-narrow.md)

- [year-month-weekday](https://clock.r-lib.org/dev/reference/year-month-weekday-narrow.md)

- [year-week-day](https://clock.r-lib.org/dev/reference/year-week-day-narrow.md)

- [iso-year-week-day](https://clock.r-lib.org/dev/reference/iso-year-week-day-narrow.md)

- [year-quarter-day](https://clock.r-lib.org/dev/reference/year-quarter-day-narrow.md)

- [year-day](https://clock.r-lib.org/dev/reference/year-day-narrow.md)
