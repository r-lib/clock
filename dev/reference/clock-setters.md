...
- [year-month-day](https://clock.r-lib.org/dev/reference/year-month-day-setters.md)

- [year-month-weekday](https://clock.r-lib.org/dev/reference/year-month-weekday-setters.md)

- [year-week-day](https://clock.r-lib.org/dev/reference/year-week-day-setters.md)

- [iso-year-week-day](https://clock.r-lib.org/dev/reference/iso-year-week-day-setters.md)

- [year-quarter-day](https://clock.r-lib.org/dev/reference/year-quarter-day-setters.md)

- [year-day](https://clock.r-lib.org/dev/reference/year-day-setters.md)

There are also convenience methods for setting certain components
directly on R's native date and date-time types.

- [dates (Date)](https://clock.r-lib.org/dev/reference/Date-setters.md)

- [date-times (POSIXct /
  POSIXlt)](https://clock.r-lib.org/dev/reference/posixt-setters.md)
