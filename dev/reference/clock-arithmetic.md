...
- [year-month-day](https://clock.r-lib.org/dev/reference/year-month-day-arithmetic.md)

- [year-month-weekday](https://clock.r-lib.org/dev/reference/year-month-weekday-arithmetic.md)

- [year-quarter-day](https://clock.r-lib.org/dev/reference/year-quarter-day-arithmetic.md)

- [year-week-day](https://clock.r-lib.org/dev/reference/year-week-day-arithmetic.md)

- [iso-year-week-day](https://clock.r-lib.org/dev/reference/iso-year-week-day-arithmetic.md)

- [year-day](https://clock.r-lib.org/dev/reference/year-day-arithmetic.md)
...
- [time-point](https://clock.r-lib.org/dev/reference/time-point-arithmetic.md)
...
- [duration](https://clock.r-lib.org/dev/reference/duration-arithmetic.md)

Weekdays can perform day-based circular arithmetic.

- [weekday](https://clock.r-lib.org/dev/reference/weekday-arithmetic.md)

There are also convenience methods for doing arithmetic directly on a
native R date or date-time type:

- [dates
  (Date)](https://clock.r-lib.org/dev/reference/Date-arithmetic.md)

- [date-times (POSIXct /
  POSIXlt)](https://clock.r-lib.org/dev/reference/posixt-arithmetic.md)
