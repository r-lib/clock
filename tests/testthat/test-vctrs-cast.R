...
test_that("<year-month> - <year-month-day>", {
  ...
  expect_identical(vec_cast(x, y), y)
...
test_that("<year-month> - <naive-time-point>", {
  ...
  w <- new_naive_time_point(new_year_month_day(), nanoseconds_of_second = integer(), precision = "millisecond")
  z <- new_naive_time_point(new_year_quarternum_quarterday())

  expect_identical(vec_cast(x, y), y)
  expect_error(vec_cast(y, x), class = "vctrs_error_incompatible_type")

  expect_identical(vec_cast(x, w), w)
  expect_error(vec_cast(w, x), class = "vctrs_error_incompatible_type")

  expect_identical(vec_cast(x, z), z)
  expect_error(vec_cast(z, x), class = "vctrs_error_incompatible_type")
})
...
test_that("<year-month-weekday> - <naive-time-point>", {
  ...
  w <- new_naive_time_point(new_year_month_weekday(), nanoseconds_of_second = integer(), precision = "millisecond")
  z <- new_naive_time_point(new_year_quarternum_quarterday())
...
test_that("<year-quarternum> - <year-quarternum>", {
  ...
  expect_identical(vec_cast(x, x), x)
  expect_identical(vec_cast(x, y), y)
  expect_identical(vec_cast(y, x), x)
})
...
test_that("<year-quarternum> - <year-quarternum-quarterday>", {
  ...
  expect_identical(vec_cast(y, z), z)
  expect_error(vec_cast(z, y), class = "vctrs_error_incompatible_type")
})
...
test_that("<year-quarternum> - <naive-time-point>", {
  ...
  expect_identical(vec_cast(x, a), a)
  expect_error(vec_cast(a, x), class = "vctrs_error_incompatible_type")

  expect_identical(vec_cast(y, a), a)
  expect_error(vec_cast(a, y), class = "vctrs_error_incompatible_type")

  expect_identical(vec_cast(x, b), b)
  expect_error(vec_cast(b, x), class = "vctrs_error_incompatible_type")
})
...
test_that("<iso-year-weeknum> - <naive-time-point>", {
  ...
  w <- new_naive_time_point(new_iso_year_weeknum_weekday(), nanoseconds_of_second = integer(), precision = "millisecond")
  z <- new_naive_time_point(new_year_quarternum_quarterday())
...
test_that("<zoned-time-point> - <zoned-time-point>", {
  ...
  expect_identical(vec_cast(x, w), w)
  expect_identical(vec_cast(w, x), x)
})
