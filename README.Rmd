...
With clock, there is a high-level API for manipulating R's native date and date-time types (Date, POSIXct, and POSIXlt). This should allow you to quickly get productive with clock without having to learn many of the new types. An easy way to get an overview of this high-level API is by looking at the [High Level API](https://r-lib.github.io/clock/reference/index.html#section-high-level-api) section of the pkgdown reference page.
