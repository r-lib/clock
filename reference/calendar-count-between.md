...
- [year-month-day](https://clock.r-lib.org/reference/year-month-day-count-between.md)

- [year-month-weekday](https://clock.r-lib.org/reference/year-month-weekday-count-between.md)

- [year-week-day](https://clock.r-lib.org/reference/year-week-day-count-between.md)

- [iso-year-week-day](https://clock.r-lib.org/reference/iso-year-week-day-count-between.md)

- [year-quarter-day](https://clock.r-lib.org/reference/year-quarter-day-count-between.md)

- [year-day](https://clock.r-lib.org/reference/year-day-count-between.md)
