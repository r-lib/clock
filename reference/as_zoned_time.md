...
- [naive-time](https://clock.r-lib.org/reference/as-zoned-time-naive-time.md)

There are also convenience methods for converting to a zoned time from
native R date and date-time types:

- [dates
  (Date)](https://clock.r-lib.org/reference/as-zoned-time-Date.md)

- [date-times (POSIXct /
  POSIXlt)](https://clock.r-lib.org/reference/as-zoned-time-posixt.md)
