...
- [dates (Date)](https://clock.r-lib.org/reference/date-shifting.md)

- [date-times
  (POSIXct/POSIXlt)](https://clock.r-lib.org/reference/posixt-shifting.md)
...
- target:
  ...
  [`weekday()`](https://clock.r-lib.org/reference/weekday.md) to target.
