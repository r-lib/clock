...
- [`set_day()`](https://clock.r-lib.org/reference/clock-setters.md) sets
  the day of the week. Valid values are in the range of `[1, 7]`, with 1
...
- index:
  ...
  [`set_day()`](https://clock.r-lib.org/reference/clock-setters.md), and
  allows you to set the index while also setting the weekday.
