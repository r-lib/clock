...
format_time_point_cpp <- function(calendar, seconds_of_day, nanoseconds_of_second, zone, format, precision, naive, abbreviate_zone, mon, mon_ab, day, day_ab, am_pm) {
  .Call("_clock_format_time_point_cpp", calendar, seconds_of_day, nanoseconds_of_second, zone, format, precision, naive, abbreviate_zone, mon, mon_ab, day, day_ab, am_pm, PACKAGE = "clock")
}
