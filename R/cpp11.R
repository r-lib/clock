...
add_years_posixct_cpp <- function(x, n, day_resolver, dst_resolver, size) {
  .Call("_civil_add_years_posixct_cpp", x, n, day_resolver, dst_resolver, size, PACKAGE = "civil")
}

add_years_local_cpp <- function(x, n, day_resolver, size) {
