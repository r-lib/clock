...
zoned_offset_cpp <- function(fields, precision_int, zone) {
  .Call("_clock_zoned_offset_cpp", fields, precision_int, zone, PACKAGE = "clock")
}

zoned_dst_cpp <- function(fields, zone) {
  .Call("_clock_zoned_dst_cpp", fields, zone, PACKAGE = "clock")
}
