...
convert_fiscal_year_quarter_day_to_naive_days <- function(year,
                                                          quarter,
                                                          day,
                                                          fiscal_start,
                                                          day_nonexistent) {
  convert_fiscal_year_quarter_day_to_naive_days_cpp(year, quarter, day, fiscal_start, day_nonexistent)
}

convert_naive_days_to_fiscal_year_quarter_day <- function(days, fiscal_start) {
  convert_naive_days_to_fiscal_year_quarter_day_cpp(days, fiscal_start)
}
