...
#' @export
as_naive_date_time <- function(x)  {
  UseMethod("as_naive_date_time")
}

#' @export
as_naive_date_time.default <- function(x) {
  stop_civil_unsupported_conversion(x, "clock_naive_date_time")
}

#' @export
as_naive_date_time.clock_naive_date_time <- function(x) {
  x
}

#' @export
as_naive_date_time.clock_calendar <- function(x) {
  x <- as_naive_second_point(x)
  as_naive_date_time(x)
}

#' @export
as_naive_date_time.clock_naive_second_point <- function(x) {
  calendar <- field_calendar(x)
  seconds_of_day <- field_seconds_of_day(x)
  calendar <- as_year_month_day(calendar)
  new_naive_date_time(calendar, seconds_of_day, names = names(x))
}

#' @export
as_naive_date_time.clock_naive_subsecond_point <- as_naive_date_time.clock_naive_second_point

#' @export
as_naive_date_time.clock_zoned_second_point <- as_naive_date_time.clock_calendar

#' @export
as_naive_date_time.clock_zoned_subsecond_point <- as_naive_date_time.clock_calendar

#' @export
as_naive_date_time.Date <- as_naive_date_time.clock_calendar

#' @export
as_naive_date_time.POSIXt <- as_naive_date_time.clock_calendar

# ------------------------------------------------------------------------------

#' @export
as_naive_date_nanotime <- function(x)  {
  UseMethod("as_naive_date_nanotime")
}

#' @export
as_naive_date_nanotime.default <- function(x) {
  stop_civil_unsupported_conversion(x, "clock_naive_date_nanotime")
}

#' @export
as_naive_date_nanotime.clock_naive_date_nanotime <- function(x) {
  x
}

#' @export
as_naive_date_nanotime.clock_calendar <- function(x) {
  x <- as_naive_subsecond_point(x, precision = "nanosecond")
  as_naive_date_nanotime(x)
}

#' @export
as_naive_date_nanotime.clock_naive_second_point <- as_naive_date_nanotime.clock_calendar

#' @export
as_naive_date_nanotime.clock_naive_subsecond_point <- function(x) {
  calendar <- field_calendar(x)
  seconds_of_day <- field_seconds_of_day(x)
  nanoseconds_of_second <- field_nanoseconds_of_second(x)
  calendar <- as_year_month_day(calendar)
  new_naive_date_nanotime(calendar, seconds_of_day, nanoseconds_of_second, names = names(x))
}

#' @export
as_naive_date_nanotime.clock_zoned_second_point <- as_naive_date_nanotime.clock_calendar

#' @export
as_naive_date_nanotime.clock_zoned_subsecond_point <- as_naive_date_nanotime.clock_calendar

#' @export
as_naive_date_nanotime.Date <- as_naive_date_nanotime.clock_calendar

#' @export
as_naive_date_nanotime.POSIXt <- as_naive_date_nanotime.clock_calendar
