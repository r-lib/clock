...
#' @export
as.Date.civil_naive <- function(x, ...) {
  days <- field(x, "days")
...
#' @export
as.POSIXct.civil_naive <- function(x,
                                   tz = "",
                                   ...,
...
#' @export
as.POSIXlt.civil_naive <- function(x,
                                   tz = "",
                                   ...,
                                   dst_nonexistent = "roll-forward",
                                   dst_ambiguous = "earliest") {
...
as_zoned_datetime.default <- function(x, ...) {
  stop_civil_unsupported_conversion(x, "civil_zoned_gregorian_datetime")
}
...
as_zoned_nano_datetime.default <- function(x, ...) {
  stop_civil_unsupported_conversion(x, "civil_zoned_gregorian_nano_datetime")
}
