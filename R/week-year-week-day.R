...
year_week_day_plus_duration <- function(x, n, precision_n) {
  start <- week_start(x)
  precision_fields <- calendar_precision_attribute(x)
  ...
  fields <- year_week_day_plus_duration_cpp(x, n, precision_fields, precision_n, start)

  new_year_week_day_from_fields(fields, precision_fields, start, names = names)
}
