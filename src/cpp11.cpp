...
extern "C" SEXP _civil_add_period_posixct_cpp(SEXP x, SEXP n, SEXP day_resolver, SEXP dst_resolver, SEXP size, SEXP unit) {
  BEGIN_CPP11
    return cpp11::as_sexp(add_period_posixct_cpp(cpp11::as_cpp<cpp11::decay_t<SEXP>>(x), cpp11::as_cpp<cpp11::decay_t<SEXP>>(n), cpp11::as_cpp<cpp11::decay_t<SEXP>>(day_resolver), cpp11::as_cpp<cpp11::decay_t<SEXP>>(dst_resolver), cpp11::as_cpp<cpp11::decay_t<SEXP>>(size), cpp11::as_cpp<cpp11::decay_t<SEXP>>(unit)));
  END_CPP11
}
// arithmetic.cpp
...
extern "C" SEXP _civil_add_period_local_cpp(SEXP x, SEXP n, SEXP day_resolver, SEXP size, SEXP unit) {
  BEGIN_CPP11
    return cpp11::as_sexp(add_period_local_cpp(cpp11::as_cpp<cpp11::decay_t<SEXP>>(x), cpp11::as_cpp<cpp11::decay_t<SEXP>>(n), cpp11::as_cpp<cpp11::decay_t<SEXP>>(day_resolver), cpp11::as_cpp<cpp11::decay_t<SEXP>>(size), cpp11::as_cpp<cpp11::decay_t<SEXP>>(unit)));
  END_CPP11
}
// initialize.cpp
SEXP civil_init();
